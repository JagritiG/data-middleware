...
# url = "https://www.epa.gov/castnet/ozone"
# url = "https://data.bloomington.in.gov/dataset/e3deefae-b7df-4a20-b32a-650bcb09a2c6/resource/a45a555b-093e-44d3-b4d4-12b1d8e7d3f3/download/2016-first-quarter-citizen-complaints.csv"
# url = "https://data.wprdc.org/dataset/9e0ce87d-07b8-420c-a8aa-9de6104f61d6/resource/72c092e5-b693-4bad-adff-2e6d0fda81b3/download/property-sale-transaction-data-dictionary.csv"
filepath = "/Users/santanusarma/Dropbox/Jagriti/Programming/Data Analysis/data_integration_middleware/data/"
get_csv(url, filepath, save2db={})
# get_csv(url, filepath, save2db=dict(host="localhost", user="root", password="password", db_type="mysql", db_name="db_name", tb_name=None))
