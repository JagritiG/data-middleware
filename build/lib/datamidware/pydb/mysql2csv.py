...
License: MIT License
===================================================================
Implementation of function mysql_2_csv() in Python:
...
def mysql_2_csv(host, user, password, file_path, db_name, tb_name):
    """
    If given pydb exists, check for given table, if table exists,
    call function export_as_csv() which writes csv file from table data.
    If given pydb or table does not exists, raise importError.
