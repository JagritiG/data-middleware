...
License: MIT License
=======================================================================================
Implementation of db_2_file() function:
...
from .mysql2csv import mysql_2_csv


def db_2_file(host, user, password, file_path, db_name, tb_name, file_type="csv", db_type="mysql"):
    """
    ...
    if file_type == "csv":
        if db_type == "mysql":
            ...
            mysql_2_csv(host, user, password, file_path=file_path, db_name=db_name, tb_name=tb_name)
